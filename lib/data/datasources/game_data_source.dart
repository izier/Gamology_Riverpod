...
import 'package:gamology_riverpod/data/models/game_detail_model.dart';
import 'package:gamology_riverpod/data/models/game_model.dart';
import 'package:gamology_riverpod/data/models/game_response.dart';
...
class GameDataSourceImpl implements GameDataSource {
  ...
  Future<List<GameModel>> getTopRatedGameList(int page) async {
    ...
    print('$baseUrl/games?page_size=15&page=$page&dates=2000-01-01,$formattedDate&ordering=-metacritic&key=$apiKey');
    final response = await client.get(
  ...
  Future<List<GameModel>> getNewReleasedGameList(int page) async {
    ...
    print('$baseUrl/games?page_size=15&page=$page&dates=$formattedThreeMonthsAgo,$formattedDate&ordering=-metacritic&key=$apiKey');
