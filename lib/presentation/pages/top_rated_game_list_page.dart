...
class TopRatedGameListPage extends ConsumerWidget {
  TopRatedGameListPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final topRatedList = ref.watch(getTopRatedListProvider(page));
                        ...
                        children: [
                          isFirstPage ? Container() : Container(
                            ...
                            child: InkWell(
                              onTap: () {
                                page--;
                                ref.watch(getTopRatedListProvider(page));
                              },
