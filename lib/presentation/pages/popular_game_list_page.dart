...
class PopularGameListPage extends ConsumerWidget {
  PopularGameListPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final popularGameList = ref.watch(getPopularGameListProvider(page));
                          ...
                          children: [
                            isFirstPage ? Container() : Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  page--;
                                  ref.watch(getPopularGameListProvider(page));
                                },
